<template>
  <nav>
    <v-app-bar app height="40" class="elevation-2">
      ...
      <v-btn  @click="go_desk" style="cursor: unset" variant="text" color="primary">
        <span right>{{ __("Home") }}</span>
      </v-btn>
  ...
  data() {
    return {
      ...
      items: [
        ...
        {text: 'Status Tracker', icon: 'mdi-clipboard-check-outline'}
      ],
      page: '',
      fav: true,
      menu: false,
